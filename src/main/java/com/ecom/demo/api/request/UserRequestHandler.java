...
public class UserRequestHandler {
	...
	@DeleteMapping("/remove/{cartId}/cart")
	public ResponseEntity deleteProductFromCart(@PathVariable("cartId") final Integer cartId)
			throws Exception{
		return userResource.deleteProductFromCart(servletContext.getUser(), cartId);
	}
}
